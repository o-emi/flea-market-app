...
#### 変更内容
- メール認証完了画面で、従来は自動で商品一覧に遷移していた仕様を、画面内ボタン操作で一覧に遷移する仕様に変更しました。
#### 変更理由
- メール認証完了後、ユーザーが自分のタイミングで次の画面に進めるように、認証完了画面に『商品一覧へ』ボタンを設置しました。これにより、ユーザーは画面上の選択肢から次の行動を直感的に選べるようになります。
